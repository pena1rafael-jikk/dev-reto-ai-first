    ...
    <div class="auth-page">
      <div class="auth-card">
        ...
        <div>
          ...
          <p class="auth-sub">Accede al portal de convocatorias públicas</p>
        </div>
...
export class LoginComponent {
  ...
  submit() {
    ...
    this.auth.login(email!, password!).subscribe({
      ...
      error: () => { this.error = 'Credenciales inválidas. Verifica tu correo y contraseña.'; this.loading = false; }
    });
  }
}
